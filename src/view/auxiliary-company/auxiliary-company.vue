...
<script>
  ...
  export default {
    ...
    methods: {
      getData() {
        this.$http({
          url: this.$api + 'produce/resources/rs/excipient/factory/list',
          method: 'post',
          data: this.params
        }).then(res => {
      ...
      add () {
        ...
        this.$http({
          url: this.$api + 'produce/resources/rs/excipient/factory/save',
          method: 'post',
          data: this.addParams
        }).then(res => {
          if (res.data.retCode === 1) {
      ...
      getDetail (item, flag) {
        this.$http({
          url: this.$api + 'produce/resources/rs/excipient/factory/getById',
          method: 'post',
          data: {
            reqParam: {
              pkId: item.pkId
      ...
      del (index) {
        this.$confirm('确认删除这条数据?', '提示', {
          ...
          this.$http({
            method: 'post',
            url: this.$api + 'produce/resources/rs/excipient/factory/delete',
            data: {
              reqParam: {
