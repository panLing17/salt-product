<template>
    <transition name="fade">
        <div class="mask auxiliary-batch-editor" v-if="maskShow">
            <div class="mask-scroll">
                ...
                <div class="mask-content fs_20">
                    ...
                    <table class="mask-table" style="margin-top: .5em">
                        ...
                        <tr>
                            <td>辅料名称</td>
                            <td>{{data.excipientInfo.mName}}</td>
                            <td>规格</td>
                            <td>{{data.excipientInfo.spec}}</td>
                        </tr>
                        <tr>
                            <td>净含量</td>
                            <td>{{data.excipientInfo.cxt}}</td>
                            <td>保质期</td>
                            <td>{{data.excipientInfo.expDate}}</td>
                        </tr>
                        <tr>
                            <td>标准号</td>
                            <td>{{data.excipientInfo.stcode}}</td>
                            <td></td>
                            <td></td>
                        </tr>
                    </table>
  ...
  export default {
    ...
    methods: {
      ...
      right () {
        ...
        this.$http({
          url: this.$api + 'produce/production/pd/excipient/batch/update',
          method: 'post',
          data: {
            reqParam: this.data
          }
