    ...
    <div class="material-info">
        <div class="top-card white-bg">
            ...
            <div class="search-wrap fs_20">
                ...
                <label class="label-2">原料名称</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      getCompanyData() {
        this.$http({
          url: this.$api + 'produce/resources/rs/raw/factory/getSelected',
          method: 'post',
          data: {
            reqParam: {}
          }
      ...
      getMaterialsData() {
        this.$http({
          url: this.$api + 'produce/resources/rs/raw/getSelected',
          method: 'post',
          data: {
            reqParam: {}
          }
      ...
      getData () {
        this.$http({
          url: this.$api + 'produce/production/pd/raw/batch/list',
          method: 'post',
          data: this.params
        }).then((res) => {
          if (res.data.retCode === 1) {
      ...
      getDetail (item, flag) {
        this.$http({
          url: this.$api + 'produce/production/pd/raw/batch/getById',
          method: 'post',
          data: {
            reqParam: {
              pkId: item.pkId
      ...
      del (index) {
        this.$confirm('确认删除这条数据?', '提示', {
          ...
          this.$http({
            method: 'post',
            url: this.$api + 'produce/production/pd/raw/batch/delete',
            data: {
              reqParam: {
